...
$httpsRepo = 'https://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2021/tlnet-final'
$httpRepo = 'http://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2021/tlnet-final'

...
$installerPath = "$scriptRoot\ProTeXt-3.1.7-061016.exe"
(New-Object System.Net.WebClient).DownloadFile('http://ftp.math.utah.edu/pub/tex/historic/systems/protext/2017-3.1.7/ProTeXt-3.1.7-061016.exe', $installerPath)
...
$pinfo = New-Object System.Diagnostics.ProcessStartInfo
$pinfo.FileName = "${protextDir}\MiKTeX\setup\setup-2.9.5987-x64.exe"

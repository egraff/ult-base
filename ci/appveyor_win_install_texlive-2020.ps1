...
$initialInstallerRepo = 'https://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2020/tlnet-final'
$tlnetRepo = 'http://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2020/tlnet-final'
